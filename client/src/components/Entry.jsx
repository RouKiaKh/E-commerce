    ...
    return (
        <article className='entry'>
            <div className='mainImageContainer'>
                <img className='mainImage' src="https://scrimba.com/links/travel-journal-japan-image-url" alt="mount fuji" />
            </div>
            <div>
                <img className='marker' src="/src/icon.png" alt="map marker icon" />
                <span>Japan</span>
